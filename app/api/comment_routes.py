...
@comment_routes.route('/<int:userId>/comment', methods=['POST'])
def new_comment():
    ...
    if comment_form.validate_on_submit():
        comment = Comment(content=comment_form.data['content'], userId=current_user.id, postId=comment_form.data['postId'])
